...
public class SocialController {
    ...
    public Map<String, Object> getMemberFromKakao(String accessToken) { // 425 반환 값 String[] -> 변경Map<String, Object>
        ...
        // 425 제거 return new String[]{"AAA", "BBB", "CCC"};
        // 425 추가
    ...
    @PutMapping("/api/member/modify") // 436 추가
