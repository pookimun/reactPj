import { API_SERVER_HOST } from "../../api/todoApi"; // 481 추가

const host = API_SERVER_HOST // 481 추가

const CartItemComponent = ({cino, pname, price, pno, qty, imageFile, changeCart, email}) => { //,484추가 changeCart 485추가, email

  const handleClickQty = (amount) => { // 481 추가

    changeCart({ email, cino, pno, qty: qty + amount}) // 484 추가  485추가 email, 
